...
def landing_recommand():
    ...
    def find_sim_course(df, sorted_ind, tag_names, top_n = 5):
  # tag 칼럼이 입력된 tag_name 값인 DataFrame추출
    ...
    similar_course = find_sim_course(course, tag_sim_sorted_ind, ['Java'], 5)
    return similar_course[['Title', 'Tag', 'Author']][:10]